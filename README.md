[![Go](https://github.com/opendilab/DI-orchestrator/actions/workflows/go.yaml/badge.svg?branch=main)](https://github.com/opendilab/DI-orchestrator/actions/workflows/go.yaml) [![Publish Releases to Hub](https://github.com/opendilab/DI-orchestrator/actions/workflows/release.yaml/badge.svg)](https://github.com/opendilab/DI-orchestrator/actions/workflows/release.yaml)
# DI Orchestrator
